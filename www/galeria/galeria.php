				    ...
				    //Consulta de una galeria especíaifa
				        ...
				        $filas = mysqli_query($cnx, $consulta);
								while( $columna = mysqli_fetch_assoc( $filas )){
									echo '<div class="col-4"><span class="image fit"><a href="foto.php?fotoid='.$columna['IDFOTO'].'" target="_blank"><img src="images/'.$columna['ARCHIVO'].'" alt="'.$columna['NOMBRE'].'" /></a></span></div>';
								}
								echo "</div>";
								echo "</div>";
								echo "<h5>$galeriaDesc[TITULO]</h5>";
